      ...
      <div className="container footer-container">
        ...
        <div className="footer-left">
          ...
          <p className="footer-description">
            At <span className="highlight">Ctrl+Beef</span>, we’re passionate about making the best burgers in town.
        ...
        <div className="footer-right">
          <div className="footer-contact">
            ...
            <p><FaMapMarkerAlt className="footer-icon" /> Talamantes 716, AGS</p>
          </div>
